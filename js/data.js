// ===== CHARACTER SVGs =====
const SPRITE_VER='?v=12';
const CHAR_SVG={
전사:{type:'sprite',frames:8,
  idle:{src:'img/warrior-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/warrior-walk.png',w:128,h:128,tw:1024},
  slash:{src:'img/warrior-slash.png',w:128,h:128,tw:1024},
  jab:{src:'img/warrior-jab.png',w:128,h:128,tw:1024},
  block:{src:'img/warrior-block.png',w:128,h:128,tw:1024}},
마법사:{type:'sprite',frames:8,
  idle:{src:'img/wizard-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/wizard-walk.png',w:128,h:128,tw:1024},
  cast:{src:'img/wizard-cast.png',w:128,h:128,tw:1024},
  slash:{src:'img/wizard-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/wizard-block.png',w:128,h:128,tw:1024}},
거너:{type:'sprite',frames:8,
  idle:{src:'img/gunner-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/gunner-walk.png',w:128,h:128,tw:1024},
  shot:{src:'img/gunner-shot.png',w:128,h:128,tw:1024},
  slash:{src:'img/gunner-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/gunner-block.png',w:128,h:128,tw:1024}},
궁수:{type:'sprite',frames:8,
  idle:{src:'img/archer-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/archer-walk.png',w:128,h:128,tw:1024},
  shot:{src:'img/archer-shot.png',w:128,h:128,tw:1024},
  slash:{src:'img/archer-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/archer-block.png',w:128,h:128,tw:1024}},
도적:{type:'sprite',frames:8,
  idle:{src:'img/thief-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/thief-walk.png',w:128,h:128,tw:1024},
  slash:{src:'img/thief-slash.png',w:128,h:128,tw:1024},
  jab:{src:'img/thief-jab.png',w:128,h:128,tw:1024},
  block:{src:'img/thief-block.png',w:128,h:128,tw:1024}},
성기사:{type:'sprite',frames:8,
  idle:{src:'img/paladin-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/paladin-walk.png',w:128,h:128,tw:1024},
  slash:{src:'img/paladin-slash.png',w:128,h:128,tw:1024},
  cast:{src:'img/paladin-cast.png',w:128,h:128,tw:1024},
  block:{src:'img/paladin-block.png',w:128,h:128,tw:1024}},
엔지니어:{type:'sprite',frames:8,
  idle:{src:'img/engineer-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/engineer-walk.png',w:128,h:128,tw:1024},
  shot:{src:'img/engineer-shot.png',w:128,h:128,tw:1024},
  slash:{src:'img/engineer-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/engineer-block.png',w:128,h:128,tw:1024}},
드루이드:{type:'sprite',frames:8,
  idle:{src:'img/druid-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/druid-walk.png',w:128,h:128,tw:1024},
  cast:{src:'img/druid-cast.png',w:128,h:128,tw:1024},
  slash:{src:'img/druid-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/druid-block.png',w:128,h:128,tw:1024}},
소환사:{type:'sprite',frames:8,
  idle:{src:'img/summoner-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/summoner-walk.png',w:128,h:128,tw:1024},
  cast:{src:'img/summoner-cast.png',w:128,h:128,tw:1024},
  slash:{src:'img/summoner-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/summoner-block.png',w:128,h:128,tw:1024}},
흑마법사:{type:'sprite',frames:8,
  idle:{src:'img/black_wizard-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/black_wizard-walk.png',w:128,h:128,tw:1024},
  cast:{src:'img/black_wizard-cast.png',w:128,h:128,tw:1024},
  slash:{src:'img/black_wizard-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/black_wizard-block.png',w:128,h:128,tw:1024}},
힐러:{type:'sprite',frames:8,
  idle:{src:'img/healer-idle.png',w:128,h:128,tw:1024},
  walk:{src:'img/healer-walk.png',w:128,h:128,tw:1024},
  cast:{src:'img/healer-cast.png',w:128,h:128,tw:1024},
  slash:{src:'img/healer-slash.png',w:128,h:128,tw:1024},
  block:{src:'img/healer-block.png',w:128,h:128,tw:1024}}
};
...
passives:[
{name:'치명타 +5%',icon:'💀',desc:'치명타 확률 5% 증가'},
...
passives:[
{name:'치명타 +8%',icon:'💀',desc:'치명타 확률 8% 증가'},
...
passives:[
{name:'치명타 +10%',icon:'💀',desc:'치명타 확률 10% 증가'},
...
skills:[
{name:'터렛 설치',icon:'🤖',desc:'자동 포탑을 설치하여 함께 싸운다',dmg:8,summon:{name:'터렛',icon:'🤖',atk:12,hp:40,count:1}},
...
{name:'드론 소환',icon:'🛸',desc:'공격 드론 2대를 소환하여 함께 싸운다',dmg:6,summon:{name:'드론',icon:'🛸',atk:11,hp:25,count:2}},
...
skills:[
{name:'임프 소환',icon:'👹',desc:'소형 악마를 소환하여 함께 싸운다',dmg:8,summon:{name:'임프',icon:'👹',atk:10,hp:30,count:2}},
{name:'골렘 소환',icon:'🗿',desc:'단단한 골렘 소환 — 높은 HP, 도발',dmg:5,summon:{name:'골렘',icon:'🗿',atk:6,hp:80,count:1,taunt:true}},
{name:'해골 소환',icon:'💀',desc:'해골 전사 3마리를 소환한다',dmg:6,summon:{name:'해골 전사',icon:'💀',atk:8,hp:20,count:3}},
{name:'정령 소환',icon:'💜',desc:'정령을 소환하여 마법 공격',dmg:10,summon:{name:'정령',icon:'💜',atk:14,hp:25,count:1}},
{name:'소환수 강화',icon:'⬆️',desc:'소환수 ATK +50%',buff:true,dmg:0,summonBuff:true},
{name:'영혼 화살',icon:'👻',desc:'원거리 영혼 공격',dmg:24},
{name:'지옥의 문',icon:'🌀',desc:'악마 무리 소환 — 광역',dmg:12,summon:{name:'악마',icon:'😈',atk:12,hp:35,count:3},aoe:true},
{name:'생명 흡수',icon:'🩸',desc:'적 HP 흡수 — 힐+딜',dmg:20},
{name:'피닉스 소환',icon:'🔥',desc:'불사조 소환 — 광역 화염',dmg:15,summon:{name:'피닉스',icon:'🔥',atk:20,hp:50,count:1},aoe:true},
{name:'저주',icon:'💀',desc:'적 약화 — DEF -50%',dmg:16},
{name:'드래곤 소환',icon:'🐉',desc:'최강 드래곤 소환 — 궁극기',dmg:25,summon:{name:'드래곤',icon:'🐉',atk:35,hp:100,count:1}}],
passives:[
...
{name:'소환수 치명타',icon:'💥',desc:'소환수 치명타 +8%'},
...
{name:'네크로맨서',icon:'💀',desc:'적 처치 시 시체를 아군으로 소환하여 함께 공격',dmg:18,necro:true},
...
skills:[
{name:'치유의 빛',icon:'💚',desc:'신성 데미지 + HP 15% 회복',dmg:18,heal:true},
{name:'재생의 바람',icon:'🍃',desc:'전체 공격 + 파티 HP 10% 회복',dmg:14,aoe:true,heal:true},
{name:'성스러운 불꽃',icon:'🔥',desc:'신성 데미지 — 언데드 특효',dmg:24},
{name:'보호막',icon:'🛡️',desc:'파티원 보호막 — DEF +30%',buff:true,dmg:0},
{name:'정화',icon:'✨',desc:'신성 공격 + 디버프 정화',dmg:16,heal:true},
{name:'빛의 심판',icon:'⚡',desc:'AoE 신성 공격',dmg:22,aoe:true},
{name:'부활의 빛',icon:'💛',desc:'강력한 신성 타격 + HP 20% 회복',dmg:20,heal:true},
{name:'신성 화살',icon:'🏹',desc:'원거리 빛 공격',dmg:22},
{name:'축복의 오라',icon:'💫',desc:'파티 DEF +30%',buff:true,dmg:0},
{name:'천사의 강림',icon:'👼',desc:'궁극 신성 공격 + 전체 HP 25% 회복',dmg:28,heal:true}],
passives:[
...
const CLASS_WEAPONS={
전사:{names:['검','대검','도끼','망치'],emojis:['🗡️','⚔️','🪓','🔨']},
마법사:{names:['지팡이','완드','스태프'],emojis:['🪄','✨','🔮']},
거너:{names:['총','라이플','샷건'],emojis:['🔫','🔫','💥']},
궁수:{names:['활','크로스보우'],emojis:['🏹','🏹']},
도적:{names:['단검','쌍검','암기'],emojis:['🗡️','⚔️','🔪']},
성기사:{names:['검','철퇴','전투망치'],emojis:['🗡️','⚜️','🔨']},
엔지니어:{names:['총','렌치','기관단총'],emojis:['🔫','🔧','💥']},
드루이드:{names:['지팡이','자연봉','덩굴채찍'],emojis:['🪄','🌿','🌿']},
소환사:{names:['지팡이','소환서','오브'],emojis:['🪄','📜','🔮']},
흑마법사:{names:['지팡이','저주봉','해골지팡이'],emojis:['🪄','💀','☠️']},
힐러:{names:['지팡이','성물','치유봉'],emojis:['🪄','💚','✨']}
};
...
const GRADE_WEIGHTS=[{g:'Normal',w:45},{g:'Magic',w:30},{g:'Rare',w:15},{g:'Unique',w:8},{g:'Epic',w:2}];
const GRADE_COLORS={Normal:'#aaaaaa',Magic:'#22ee66',Rare:'#4499ff',Unique:'#bb55ff',Epic:'#ff8800'};
...
// 치명타
{name:'🎯 민첩 +1%',desc:'치명타 확률 1% 증가',apply:p=>{p.critBonus=(p.critBonus||0)+1}},
{name:'🎯 민첩 +1%',desc:'치명타 확률 1% 증가',apply:p=>{p.critBonus=(p.critBonus||0)+1}},
{name:'🎯 날렵함',desc:'치명타 확률 2% 증가',apply:p=>{p.critBonus=(p.critBonus||0)+2}},
// 공격속도
...
// 복합
{name:'🔥 전투 본능',desc:'ATK+1, 치명타+1%',apply:p=>{p.atk+=1;p.critBonus=(p.critBonus||0)+1}},
