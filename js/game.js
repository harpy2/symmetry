...
charHTML=`<div class="char-sprite" style="background-image:url('${charData.src}');width:${charData.w}px;height:${charData.h}px;animation:spriteWalk ${charData.frames*0.1}s steps(${charData.frames}) infinite"></div>`;
